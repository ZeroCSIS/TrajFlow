...
Due to policy restrictions, we could not distribute real dataset. The included `toy_trajflow/` folder is fully synthetic and is provided only to document the processed data format expected by the released code.
